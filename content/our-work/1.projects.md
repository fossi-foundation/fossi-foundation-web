...
::ff-cards{class="mt-64"}
  ...
  headline: LibreLane
  linkTo: /librelane
  img: /librelane/images/librelane-logo-full.svg
  imgObjectCover: false
  ---

  Free and open source ASIC flow infrastructure library and successor project to
  the most popular open source ASIC flow, OpenLane
  ::
