...
Originally developed for MIT's FPGA design curriculum, Manta is an open-source, device-agnostic and platform-independent tool for debugging FPGA designs on-chip. Manta is written in Amaranth, a modern HDL built on Python. This allows Manta to generate Verilog-2001 for any toolchain, and provides first-party support for AMD, Intel, Lattice, and QuickLogic FPGAs. Being written in Amaranth also allows Manta to run on any machine supported by Python, allowing for Manta's embedded Logic Analyzer and IO Cores to be accessed by any host machine with a UART or network connection to the FPGA. While originally intended as a debugging tool, Manta is being extended to serve as a reliable transport layer between a FPGA and a host machine.
...
| 13:40 | Break                                                                                |
| 14:20 | Manta: A Configurable and Approachable Tool for FPGA Debugging and Rapid Prototyping |
...
| 17:00 | Talks(30-40m)/Pizza at Draper							       |
